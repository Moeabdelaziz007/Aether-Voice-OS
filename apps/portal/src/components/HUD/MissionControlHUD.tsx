...
export default function MissionControlHUD() {
  ...
  return (
    <div className="absolute right-8 bottom-10 z-30 w-[min(560px,46vw)] space-y-3 pointer-events-none">
      <div className="rounded-2xl border border-white/10 bg-black/45 backdrop-blur-md p-4 shadow-[0_0_40px_rgba(0,243,255,0.1)]">
      ...
      <div className="rounded-2xl border border-white/10 bg-black/45 backdrop-blur-md p-4 shadow-[0_0_40px_rgba(57,255,20,0.08)]">
