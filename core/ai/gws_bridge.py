...
class GWSMCPClient:
    ...
    async def _connect(self):
        ...
        try:
            ...
            self._reconnect_attempts = 0
            logger.info("GWS MCP Connection established. Discovered %d tools and %d skills/prompts.", len(self._tools_cache), len(self._prompts_cache))
...
def get_discovered_tools() -> List[Dict[str, Any]]:
    ...
    tools.append({
        ...
        "parameters": {
            "type": "object",
            "properties": {
                "category": {"type": "string", "description": "Optional category filter (e.g., 'research', 'automation')"}
            }
        },
    ...
    tools.append({
        ...
        "handler": lambda skill_name, arguments=None, **kwargs: gws_bridge.execute_prompt(skill_name, arguments or {})
    })
