...
class AudioTelemetryLogger:
    ...
    def get_session_metrics(self) -> SessionMetrics:
        ...
        metrics = SessionMetrics(
            ...
            aec_convergence_rate=sum(1 for f in frames if f.aec_converged) / n if n > 0 else 0,
    ...
    def get_real_time_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "aec_converged": any(f.aec_converged for f in list(self._frame_metrics)[-100:]),
            "speech_active": any(f.vad_is_speech for f in list(self._frame_metrics)[-10:]),
        }
