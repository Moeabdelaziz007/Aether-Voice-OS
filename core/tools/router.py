...
class ToolRouter:
    ...
    def __init__(self) -> None:
        ...
        self._profiler = container.get('toolexecutionprofiler'))
        self._vector_store: Optional[LocalVectorStore] = None
        self._biometric_middleware = container.get('biometricmiddleware')fallback_authorized=True)
    ...
    def register(
        ...
        self._tools[name] = container.get('toolregistration')
            name=name,
