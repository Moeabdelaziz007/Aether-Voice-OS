...
async def run_comprehensive_test():
    ...
    if all_results:
        ...
        print(f"  Latency Range: {summary_report['summary_statistics']['min_latency_p95_ms']:.1f}ms - {summary_report['summary_statistics']['max_latency_p95_ms']:.1f}ms")
        print(f"  Average AEC Convergence: {summary_report['summary_statistics']['average_aec_convergence_percent']:.1f}%")
