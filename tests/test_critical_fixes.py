...
class TestExceptionHandling:
    ...
    def test_rust_cortex_exception_handling(self):
        ...
        with patch("pyaudio.PyAudio") as mock_pyaudio:
            mock_pyaudio.return_value.get_default_input_device_info.return_value = {"defaultSampleRate": 16000}
    ...
    def test_playback_callback_exception_handler(self):
        ...
        with patch("pyaudio.PyAudio") as mock_pyaudio:
            mock_pyaudio.return_value.get_default_output_device_info.return_value = {"defaultSampleRate": 24000}
...
class TestAsyncToSyncConversion:
    ...
    def test_pre_train_is_sync_function(self):
        ...
        with patch("core.audio.dynamic_aec.AdaptiveFilter"):
            ...
            assert not asyncio.iscoroutinefunction(aec.pre_train), "pre_train should NOT be async anymore"
...
class TestBufferOptimization:
    ...
    def test_reset_uses_clear_not_reassignment(self):
        ...
        with patch("core.audio.dynamic_aec.AdaptiveFilter"):
            ...
            assert far_end_id_before == far_end_id_after, "Should reuse same buffer object, not create new one"
            assert near_end_id_before == near_end_id_after, "Should reuse same buffer object, not create new one"
            assert far_end_acc_id_before == far_end_acc_id_after, "Should reuse same buffer object, not create new one"
