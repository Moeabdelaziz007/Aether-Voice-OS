...
async def test_sentiment_analytics_logic():
    ...
    print(f"Excited Audio: Pitch={res_excited.pitch_estimate:.2f}, Engagement={res_excited.engagement_score:.2f}")
    ...
    print(f"Varied Audio: Variance={res_varied.rms_variance:.2f}, Engagement={res_varied.engagement_score:.2f}")
