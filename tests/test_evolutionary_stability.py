...
async def test_multi_turn_evolution():
    ...
    mock_firebase.get_session_affective_summary = AsyncMock(return_value={
        "status": "success",
        "summary": {"avg_engagement": 0.2, "avg_pitch": 190.0, "trend": "declining", "interaction_count": 15}
    })
    ...
    mock_firebase.get_session_affective_summary = AsyncMock(return_value={
        "status": "success",
        "summary": {"avg_engagement": 0.6, "avg_pitch": 210.0, "trend": "volatile", "interruption_rate": 0.8, "interaction_count": 12}
    })
    ...
    mock_firebase.get_session_affective_summary = AsyncMock(return_value={
        "status": "success",
        "summary": {"avg_engagement": 0.95, "avg_pitch": 140.0, "trend": "stable", "interruption_rate": 0.05, "interaction_count": 20}
    })
