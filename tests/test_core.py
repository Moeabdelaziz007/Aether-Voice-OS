...
class TestConfig:
    ...
    def test_load_config_with_json_fallback(self):
        ...
        try:
            ...
            with patch.dict(os.environ, {}, clear=True):
                ...
                assert os.environ["AETHER_AI_MODEL"] == "gemini-2.5-flash-native-audio-preview-12-2025"
        finally:
            if exists:
    ...
    def test_load_config_missing_key_raises(self):
        ...
        backup_path = Path("aether_runtime_config.json.bak")
        exists = json_path.exists()
        if exists: shutil.move(json_path, backup_path)
        ...
        try:
            ...
            if exists: shutil.move(backup_path, json_path)
...
class TestToolDeclarations:
    ...
    def test_all_tools_have_handler(self):
        ...
        from core.tools import system_tool, tasks_tool, memory_tool, voice_tool
...
class TestToolRouter:
    ...
    def test_register_multiple_modules(self):
        from core.tools.router import ToolRouter
        from core.tools import system_tool, memory_tool
        router = ToolRouter()
        router.register_module(system_tool)
