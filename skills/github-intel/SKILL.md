...
- [references/github-tricks.md](references/github-tricks.md) — URL hacks, API shortcuts, search operators

## Script Reference

- `scripts/repo_analyzer.py` — Full repository analysis with diagrams
- `scripts/repo_to_markdown.py` — Convert repo to single markdown document
